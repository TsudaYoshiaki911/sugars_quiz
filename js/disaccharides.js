...
const question_list = [
    {img: 'image/maltose.jpg', name: 'マルトース'},
    {img: 'image/sucrose.jpg', name: 'スクロース'},
    {img: 'image/serobiose.jpg', name: 'セロビオース'},
    {img: 'image/lactose.jpg', name: 'ラクトース'},
    {img: 'image/trehalose.jpg', name: 'トレハロース'}
];
